module.exports = class Data1695298720876 {
    name = 'Data1695298720876'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "transaction" ("id" character varying NOT NULL, "proposal_tx_hash" text NOT NULL, "execution_tx_hash" text, "tx_id" numeric NOT NULL, "proposer" text NOT NULL, "contract_address" text NOT NULL, "selector" text NOT NULL, "method_name" text, "args" text NOT NULL, "args_human_readable" bytea, "value" numeric NOT NULL, "status" character varying(16) NOT NULL, "error" text, "approval_count" integer NOT NULL, "rejection_count" integer NOT NULL, "creation_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "creation_block_number" integer NOT NULL, "last_updated_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "last_updated_block_number" integer NOT NULL, "multisig_id" character varying, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "external_transaction_data" ("id" character varying NOT NULL, "tx_hash" text NOT NULL, "method_name" text NOT NULL, "args" bytea NOT NULL, "creation_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "in_use" boolean NOT NULL, CONSTRAINT "PK_caf6c1ca405ec201369711fe6bf" PRIMARY KEY ("id"))`)
